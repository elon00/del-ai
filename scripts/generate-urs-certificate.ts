/**
 * Delphi Agent Arena (del-ai) — URS Evidence Certificate Generator
...
console.log('╔══════════════════════════════════════════════════════════════════════════╗');
console.log('║   DELPHI AGENT ARENA (DEL-AI) — URS EVIDENCE CERTIFICATE                 ║');
console.log('╚══════════════════════════════════════════════════════════════════════════╝\n');
...
const rootSeed = new Uint8Array(32).fill(0xc1);
const certAuthority = ml_dsa65.keygen(rootSeed);

const certificatePayload = {
  protocol: 'Delphi-Agent-Arena-del-ai',
  ...
  truthTaxonomy: {
    ...
    delphiMarketEngine: 'KELLY_CRITERION_POSITION_SIZING',
    latticePolynomialRing: 'R_Q_DEGREE_256_MOD_3329',
